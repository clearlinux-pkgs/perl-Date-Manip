...
Source0  : https://cpan.metacpan.org/authors/id/S/SB/SBECK/Date-Manip-6.96.tar.gz
...
%prep
%setup -q -n Date-Manip-6.96
cd %{_builddir}/Date-Manip-6.96
pushd ..
cp -a Date-Manip-6.96 buildavx2
popd
