...
Source0  : https://cpan.metacpan.org/authors/id/S/SB/SBECK/Date-Manip-6.94.tar.gz
...
%prep
%setup -q -n Date-Manip-6.94
cd %{_builddir}/Date-Manip-6.94
pushd ..
cp -a Date-Manip-6.94 buildavx2
popd
