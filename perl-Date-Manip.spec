...
Source0  : https://cpan.metacpan.org/authors/id/S/SB/SBECK/Date-Manip-6.97.tar.gz
...
%prep
%setup -q -n Date-Manip-6.97
cd %{_builddir}/Date-Manip-6.97
pushd ..
cp -a Date-Manip-6.97 buildavx2
popd
